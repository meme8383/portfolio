  ...
  return (
    <section>
      ...
      <p className="mb-4">
        ...
        In my research, I develop machine learning models to interpret mouse brain signals. I enjoy working on challenging projects and learning new things, as well as pursuing hobbies like guitar, cooking, and gaming.`}
      </p>
      <Links />
    </section>
  );
